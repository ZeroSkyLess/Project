...
void GS(int sa)
{
	...
	{	
		...
		else
		{
			...
			strcpy(aa,intro[0].name);
			strcpy(bb,intro[0].name);
	...
	if(intro[0].mark == intro[1].mark && intro[0].mark == intro[2].mark)
	{
				...
				strcpy(highname,intro[0].name);
				strcpy(mediumname,intro[1].name);
				strcpy(lowname,intro[2].name);
	...
	else if(intro[0].mark == intro[1].mark)
	{
		...
		else 
		{
				...
				strcpy(highname,intro[2].name);
				strcpy(mediumname,intro[0].name);
				strcpy(lowname,intro[1].name);
	...
	else if(intro[0].mark == intro[2].mark)
	{
		...
		if(intro[0].mark > intro[1].mark)
		{
			...
			strcpy(highname,intro[0].name);
			strcpy(mediumname,intro[2].name);
			strcpy(lowname,intro[1].name);
	...
	else
	{
		...
		{ 
			...
			if (intro[q].mark < highest && intro[q].mark > lowest)
			{
					...
					strcpy(mediumname,intro[q].name);
		...
		strcpy(FIRST,highname);
		strcpy(SECOND,mediumname);
		strcpy(THIRD,lowname);
...
void data()
{
	...
	saveFile<< Time.date << endl << round << FIRST << *HIGH << endl 
