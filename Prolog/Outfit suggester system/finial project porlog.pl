...
%Male dinner
hypothesize(male,formal,white_collar)   :- event(dinner), impression(smart), !.
hypothesize(male,formal,white_tuxedo)   :- event(diner), impression(elegant), !.
hypothesize(male,formal,sweaters)   :- event(dinner), impression(hardworking), !.
